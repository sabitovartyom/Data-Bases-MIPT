...
(1, 'Personal Loan', 5.5, 10000.00, 1, '2023-01-01', '2025-12-31'),
(2, 'Car Loan', 4.0, 20000.00, 1, '2023-01-01', NULL),
(3, 'Home Loan', 3.5, 50000.00, 0, '2022-01-01', '2023-12-31'),
(4, 'Education Loan', 6.0, 15000.00, 1, '2024-01-01', NULL),
(5, 'Business Loan', 7.0, 30000.00, 1, '2023-06-01', '2026-06-01');
...
(1, 1, 'account', 2, NULL, '2024-03-01', 500.00),
(2, 2, 'loan', NULL, 1, '2024-03-05', 1000.00),
(3, 3, 'account', 4, NULL, '2024-03-10', 200.00),
(4, 1, 'loan', NULL, 2, '2024-03-15', 1500.00),
(5, 5, 'account', 6, NULL, '2024-04-01', 300.00),
(6, 7, 'loan', NULL, 3, '2024-04-10', 800.00),
(7, 8, 'account', 9, NULL, '2024-05-05', 400.00),
(8, 10, 'loan', NULL, 4, '2024-05-15', 1200.00),
(9, 11, 'account', 12, NULL, '2024-06-01', 600.00),
(10, 13, 'loan', NULL, 5, '2024-06-10', 2000.00),
(11, 14, 'account', 15, NULL, '2024-07-01', 700.00),
(12, 15, 'loan', NULL, 6, '2024-07-15', 2500.00);